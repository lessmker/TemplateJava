 ...
 * @Description: 轮播图
 */
public class LauncherScrollDelegate extends KerDelegate implements OnItemClickListener {
    ...
    public void onItemClick(int position) {
        ...
        if (position == (INTEGERS.size() - 1)) {
            KerPreference.setAppFlag(ScrollLauncherTag.HAS_FIRST_LAUNCHER_APP.name(), true);
            //检查用户是否已经登录
