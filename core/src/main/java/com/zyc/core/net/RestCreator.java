...
//    }
    ...
    private static final class RetrofitHolder {
        private static final String BASE_URL = App.getConfiguration(ConfigKeys.API_HOST);
    ...
    private static final class OkHttpHolder {//对okhttp的惰性初始化
        ...
        private static final ArrayList<Interceptor> INTERCEPTORS = App.getConfiguration(ConfigKeys.INTERCEPTOR);
